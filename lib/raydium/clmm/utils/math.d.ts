...
import { h as ReturnTypeGetLiquidityAmountOut, P as TickArray, T as TickArrayBitmapExtensionType } from '../../../type-25785933.js';
import { k as ApiV3PoolInfoConcentratedItem } from '../../../type-7ae06f8f.js';
...
declare abstract class SwapMath {
    ...
    }, tickArrayBitmap: BN__default[], tickarrayBitmapExtension: TickArrayBitmapExtensionType, zeroForOne: boolean, fee: number, liquidity: BN__default, currentTick: number, tickSpacing: number, currentSqrtPriceX64: BN__default, amountSpecified: BN__default, lastSavedTickArrayStartIndex: number, sqrtPriceLimitX64?: BN__default): {
